    ...
    <section id="hero" className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 w-full max-w-5xl mx-auto flex flex-col items-center">
        <div className="overflow-hidden mb-4">
          <motion.h1 
            className="text-[4rem] sm:text-[6rem] md:text-[8rem] lg:text-[10rem] font-serif text-titli mb-2 leading-none"
            initial={{ y: '100%' }}
        ...
        <div className="overflow-hidden mb-8">
           <motion.h2
            className="text-3xl md:text-5xl lg:text-7xl font-sans font-light tracking-wide text-white/90"
            initial={{ y: '-100%' }}
            animate={{ y: isLoaded ? '0%' : '-100%' }}
        ...
        >
          <p className="text-sm md:text-lg font-sans text-white/70 tracking-[0.3em] uppercase mb-2">
            Theatre and Cinema
          </p>
          <div className="flex items-center gap-4">
            <span className="h-px w-8 md:w-16 bg-accent-orange block"></span>
            <p className="text-base md:text-xl font-serif text-accent-orange italic">
